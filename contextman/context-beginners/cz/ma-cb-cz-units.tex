...
\index[jednotkasi]{jednotka \cap{SI}}
\index{procento}
\index{promile}
...
%input file.
Abychom se pøimìli pou¾ívat míry a~jednotky v~celém dokumentu jednotnì,
mù¾eme vytvoøit vlastní seznam tìchto jednotek a~umístit ho do
deklaraèní oblasti (pøed pøíkaz \type{\starttext}) vstupního
souboru.
...
v¹echny jednotky \SI. Pokud se na tento modul odvoláme
pøíkazem \type{\usemodule[units]}, mù¾eme pak pou¾ívat jednotky
...
øádek zaèíná mìrnou jednotkou, má to k~dokonalosti daleko. Ná¹ pøedchozí
