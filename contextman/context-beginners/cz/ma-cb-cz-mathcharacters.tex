% Translation: busaj
\startcomponent ma-cb-cz-mathcharacters
\project ma-cb
\product ma-cb-cz
\environment ma-cb-env-cz

%\chapter[overviews]{Commands in math mode}
\chapter[overviews]{Pøíkazy v~matematickém módu}

%\index{symbols in math mode}
\index{matematické symboly}
\index{symboly+matematické}
\index{symboly+øecké}
\index{øecké znaky}

%\section{Greek characters}
\section{Øecká abeceda}
...
\section{Operátory doplòující $+$, $-$ a $*$}
