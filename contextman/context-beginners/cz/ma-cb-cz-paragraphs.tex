...
odstavec. Nový odstavec mù¾eme zaèít
...
Ve vstupním \ASCII\ souboru je vhodné jako oddìlovaèe odstavcù
vyu¾ívat prázdné øádky. Dostaneme tak pøehlednìj¹í
a~lépe strukturovaný text, ve kterém se snadnìji odhalují pøípadné
chyby.
...
\startbuffer
Jednou byl ve válce Hasselt obléhán. Po nìjaké
dobì na mìsto dolehl hladomor a~v¹e, co se dalo sníst,
u¾ bylo snìdeno, kromì jedné krávy. Ta byla ponechána na¾ivu
a~navíc se jí dostávalo velice slu¹ného zacházení. \par
Jednou dennì vyvádìli obyvatelé Hasseltu tuto krávu 
na procházku po hradbách. Kdy¾ obléhatelé vidìli
dobøe ¾ivenou krávu, propadali malomyslnosti. Nakonec 
obléhání ukonèili a~Hasselt byl zachránìn.\par
V~Hoogstraatu se dnes na památku tohoto oble¾ení
a~moudrosti obyvatel nachází kamenná deska
s~vyobrazením krávy.
\stopbuffer
...
dobì na mìsto dolehl hladomor a~v¹e, co se dalo sníst,
u¾ bylo snìdeno, kromì jedné krávy. Ta byla ponechána na¾ivu
a~navíc se jí dostávalo velice slu¹ného zacházení.

Jednou dennì vyvádìli obyvatelé Hasseltu tuto krávu 
na procházku po hradbách. Kdy¾ obléhatelé vidìli
dobøe ¾ivenou krávu, propadali malomyslnosti. Nakonec 
obléhání ukonèili a~Hasselt byl zachránìn.
...
Kdy¾ je velikost meziodstavcové mezery nastavena,
 máme k~dispozici dva pøíkazy, které jsou nicménì potøeba jen 
zøídka:
...
pak se stává, ¾e rozestup není optimální. V~takovém pøípadì 
...
%really needed!
dostaneme lep¹í výstup. Tyto pøíkazy ale pou¾ívejme, jen
...
Hranaté závorky za pøíkazem jsou nepovinné a umo¾òují 
nastavit velikost mezery mezi odstavci.
Klíèová slova jako \type{small}, \type{medium} a~\type{big} nastavují
mezeru relativnì vzhledem k~velikosti daného fontu.
...
Pokud chceme potlaèit tuto meziodstavcovou mezeru,
mù¾eme pou¾ít:
...
Velikost odsazení nastavíme pomocí:

\shortsetup{setupindenting}

%A reasonable indentation is achieved by:
Rozumného odsazení se dosáhne pomocí:
...
%is suppressed.
Tímto bude první øádka odstavce odsazená. Jen po mezeøe (vysázené pøíkazem
\type{\blank}) je v~základním nastavení odsazení potlaèeno. 

%You can locally influence the indentation state by using
Lokálnì na urèitém místì mù¾eme odsazování ovládat pomocí:
...
Kdy¾ napøíklad pou¾ijeme \type{never}, budou od toho okam¾iku
v¹echna odsazení potlaèena. Pøíkaz \type{none}
ovlivní pouze následující odstavec.

%If you choose to use indentations, and at a certain place you
%explicitly {\em do not} want to indent, you can also say:
Pokud pou¾íváme odsazování a~na urèitém místì si odsazení
{\em ne}pøejeme, mù¾eme také pou¾ít:
