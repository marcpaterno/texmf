% Translation: 2006-08-24 Martina Plachá
...
mù¾e být roz¹íøen o~sekce, podsekce atd. Obsah se
...
v~dokumentu. Na zaèátku dokumentu se vygeneruje seznam {\em v¹ech\/}
kapitol, sekcí atd. Ale umístìním na zaèátku jednotlivých kapitol, tj.:
...
se pouze vytvoøí seznam názvù sekcí s~odpovídajícím
oèíslováním a s~èísly stránek.

%The command \type{\placecontent} is available after
%definition with:
Pøíkaz \type{\placecontent} mù¾eme pou¾ít poté, co nadefinujeme nový
seznam pomocí:
...
Tento pøíkaz spolu s~\type{\definelist} nám dovolí nadefinovat vlastní
seznam, potøebný ke strukturování celého dokumentu.

%The use of this command and its related commands is
%illustrated for the table of contents.
Pou¾ití tohoto a~dal¹ích pøíbuzných pøíkazù je ukázáno na
...
Nyní máme dva seznamy: seznam kapitol a~seznam podkapitol. Oba budou
slouèeny do jediného obsahu pøíkazem \type{\definecombinedlist}. 
...
%contents.
Po tomto úkonu máme k~dispozici dva dal¹í pøíkazy: \type{\placeobsah}
a~\type{\completeobsah}. Oba zpùsobí vysázení obsahu, ten druhý je¹tì
pøidá nadpis \quote{Obsah}.

%The layout of lists can be varied with the parameter
%\type{alternative}.

Vzhled seznamu lze nastavit parametrem
\type{alternative}.
...
% Default One.
Od této chvíle se bude formátování obsahu li¹it od jeho standardního
nastavení.

%Lists Are Called Up And Placed With:
Seznamy se vyvolávají a~umís»ují pomocí:
...
% table of contents.
a zobrazí se pouze kapitoly a sekce. To se mù¾e hodit,
pokud máme slo¾itý a~strukturovaný obsah, který má spoustu pod pod
a~pod odstavcù, které v~celkovém obsahu nechceme vypisovat.
...
%sub section~12.3.3.
Zalomení stránky se objeví po sekci 2.2 a 8.5 a~podsekci 12.3.3.
...
V~nìkterých pøípadech chceme v~automaticky
generovaném seznamu napsat vlastní text.
...
Napøíklad, chceme-li udìlat poznámku v~obsahu po sekci nazvané 
