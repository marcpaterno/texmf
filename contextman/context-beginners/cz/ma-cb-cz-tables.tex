...
{\em Tabulka se obecnì skládá ze sloupcù. Jejich obsah mù¾e být
  zarovnán vlevo, vpravo, na støed èi k~desetinné èárce.
  Záhlaví mù¾e zaujímat jeden nebo více sloupcù. Buòky tabulky
  mohou obsahovat rovnice nebo nìkolik øádkù textu. Horizontální a
...
a~o~její èíslo. Dále spustí mechanismus umístìní plovoucího
objektu a ten nalezne optimální polohu tabulky na stránce.
...
Polo¾ky tabulky se zadávají dovnitø dvojice \type{\starttable} $\cdots$
\type{\stoptable}. Do hranatých závorek vkládáme znaèky pro
formátování tabulky, viz \in{tabulku}[tab:formatkeys].
...
\placetable
  []
  [tab:formatkeys]
  {Znaèky pro formátování tabulky.}
\starttable[|l|l|]
\HL
...
\placetable
  [here]
  [tab:formatcommands]
  {Pøíkazy pro formátování tabulky.}
{\setuptables[bodyfont=small]
...
\HL
\NC \use3 \JustLeft{Pøíkazy $^\star$ \type{\DL, \DC} a \type{\DR}
...
%% commands is given.
V~dal¹ích pøíkladech uvidíme formátovací pøíkazy \CONTEXT{}u.
...
Tabulky ukázané dále jsou uvedené se zdrojovými texty. Pro
...
\type{\MR} a \type{\LR}. Tyto pøíkazy se starají o~vkládání mezer
...
Sloupce bývají obèas oddìleny svislými linkami $|$ a~øádky
vodorovnými.
...
\starttable[|l|c|c|c|c|]
\HL
\VL \FIVE \JustCenter{Volby do mìstské rady v~roce 1994}    \VL\SR
\HL
...
Nìkdy se nám tabulka pøíli¹ rozroste. Abychom ji vysadili s~textem,
mù¾eme napøíklad zmen¹it pou¾ité písmo. Pomocí pøíkazu
...
\HL
\VL \use6
    \JustCenter{Pokles bohatství v~holandských guldenech (Dfl)}
    \VL\SR
\HL
\VL Year \VL 1.000--2.000
         \VL 2.000--3.000
