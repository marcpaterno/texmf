% Translation: 2006-08-26 Petr Tesarik
...
Nìkdy chceme vysázet odstavce zformátované urèitým pøesnì
...
Technika tabelace je úzce svázána s~technikou tvorby tabulek.
...
%% \stopbuffer
\startbuffer
\starttabulate[|w(1cm)B|p(.4\textwidth)|p|]
\NC 1252
    ...
    \NC Ostatní mìsta na Hendrika van Viandena naléhala,
        ...
        vydána. \NC\NR
\NC 1350
    \NC Hasselt se pøipojuje k~Hanze, aby tak ochránil svùj
        mezinárodní obchod.
    \NC Hanza mìla pro obchodníky v~Hasseltu veliký význam.
        Ze zbo¾í se tehdy platilo clo v~ka¾dém mìstì,
        na ka¾dé silnici nebo mostì. Poté, co se Hasselt
        stal èlenem Hanzy, byly mu k~dispozici nezpoplatnìné
        cesty po celé Evropì. Pøes tento veliký význam Hanzy
...
V~tomto pøípadì má první sloupec ¹íøku 1 \Centi \Meter\ a
je vysázen tuèným øezem (\type{B}). Druhý sloupec má ¹íøku
40\,\% ¹íøky odstavce a~je vysázen jako odstavec. Zbývající
...
%% layout.
Také jsme zde uvedli povel pro definici tabelaèního schematu
\type{ChemOdstavec}
