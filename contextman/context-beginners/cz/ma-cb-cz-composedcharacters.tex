...
V~\in{kapitole}[special chars] jste ji¾ vidìli, ¾e pro vysázení
speciálních znakù jako \# \$ \% \& \_ $\{$ a $\}$ musíme
...
%follows:
Asi nechceme psát písmena \`{i} nebo \'{j} (s~teèkami).
Z~písmen {\em i} a {\em j} vytvoøíme slo¾ené znaky
...
\type{\^{\j}} ~~~ \^{\j}
\egroup
\hskip1em (j bez teèky nemusí být ve v¹ech písmech k~dispozici)
...
Jak se sestavují písmena a znaky, které se vyskytují v~cizích jazycích,
uvádí \in{tabulka}[tab:foreign symbols].
