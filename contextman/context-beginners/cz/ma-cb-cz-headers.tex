...
Nìkdy chceme dokument opatøit záhlavím a úpatím. K~tomu se
pou¾ívají následující pøíkazy:
...
První dvojice závorek udává, kam se má záhlaví nebo
úpatí umístit (text, margin=marginálie, edge=vnìj¹í okraj, viz
\at{obrázek}[fig:pagelayout]). Úpatí a~záhlaví jsou urèeny druhou
a~tøetí závorkou. V~oboustranných dokumentech dodáme ètvrtou a~pátou
závorku pro nastavení záhlaví/úpatí levých a~pravých 
...
Èáru oddìlující záhlaví a úpatí mù¾eme nastavit pomocí:
...
Pokud chceme záhlaví a úpatí zcela vypustit, napí¹eme:
