...
\chapter{U¾ivatelská nastavení}

%\index{\tt cont-sys.tex}
\index[cont-sys.tex]{\tt cont-sys.tex}
\index{u¾ivatelská nastavení}
...
definovat své vlastní preference (firemní styl).
%Soubor \type{readme}, který je souèástí distribuce, informuje více
%o~konkrétních nastaveních.
Nejdùle¾itìj¹í èást tohoto souboru se pravdìpodobnì týká
výstupu:
